...
public class BoardRestController {
    ...
    public ResponseEntity<ApiUtil<BoardResponse.DetailDTO>> detail(@PathVariable(name = "id") Long id, HttpSession session) {
    ...
    public ResponseEntity<?> save(@RequestParam BoardRequest.SaveDTO saveDTO, HttpSession session) {
    ...
    public ResponseEntity<?> update(@PathVariable(name = "id") Long id, @RequestBody BoardRequest.UpdateDTO updateDTO, HttpSession session) {
